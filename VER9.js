...
let conifertreeimg, bush1, bush2, mountain1, mountain2, lake1, lake2, sun1, sun2, sun3, cucloud1, cucloud2, cicloud1, cicloud2, grass1, grass2, treeimg2, fence1, fence2, barnimg, rock1, rock2, fog1, fog2;
let mountainCount = 0;
let coniferCount = 0;
let bushCount = 0;
...
var bushesInfo = {
  y:
random(windowHeight/1.33, windowHeight/1.6),
  image:
random(bushArray),
  count:
bushCount
...
var grassInfo = {
  y:
random(windowHeight/1.1, windowHeight/1.2),
  count:
grassCount,
image:random(grassImageArray)
  }
...
function draw() {
  ...
  for (let i = 0; i < totalRows; i++) {
    ...
    if (path == "1") {
      fill("brown");
      noStroke();
      rect(xPos, pathInfoArray[i].y, 60, 20);
    }
    //HOVER FOR PATH
